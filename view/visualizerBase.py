...
class VisualizerBase(ABC):
    ...
    def _add_vertices(self, simulation, graph):
        ...
        for person in simulation.graphs["friends"].get_vertices():
            if person:
    ...
    def _friends_graph(self, simulation, graph):
        ...
        if type(simulation.graphs["friends"]) == WeightedUndirectedMatrixGraph or type(simulation.graphs["friends"]) == WeightedUndirectedListGraph:
